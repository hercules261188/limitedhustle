...
<body>
	<form class="text-center border border-light p-5" action="" method="post">
	    <p class="h4 mb-4">Limited Hustle Question Form</p>
	    ...
	    <div class="form-group">
	        <textarea class="form-control rounded-0" id="exampleFormControlTextarea2" rows="3" placeholder="Your Question" name="message"></textarea>
	    </div>
...
<?php
	if(isset($_POST['submit'])){
		...
		$txt= 'Name: '.$name.' , Email: '.$email.' , Message: '.$message.' , Instagram: <a href="https://instagram.com/'.$instagram.'">'.$instagram.'</a>';
